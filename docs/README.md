...
| [`context/`](context/) | Context window assembly, retrieval, memory, efficiency notes (`context-management.md`, `memory-system.md`, `vector-db-implementation-plan.md`, …), including dynamic project-tree path grounding and background-op footer/log indicators. **Refactor plan:** [`planning/context-ingestion-refactor.md`](planning/context-ingestion-refactor.md) (layered ingestion, working set; final step updates this doc + `architecture-maps/`). |
| [`tooling/`](tooling/) | Harness iteration, tool catalog narrative, **[tool dispatch inventory](tooling/tool-dispatch-inventory.md)** (compat aliases, console policy), tools expansion, audits, agent requirements, Fab tool plan. **Agent delegation:** [`planning/tooling-subagent-delegation.md`](planning/tooling-subagent-delegation.md) (orchestrator + product specialists, tool surfaces). |
